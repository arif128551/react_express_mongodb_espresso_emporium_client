		...
		>
			<div className="container max-w-7xl mx-auto">
				...
				<div className="mt-12 bg-cf5f4f1 lg:py-18 lg:px-28 sm:p-10 p-5 rounded-md">
					...
					<p className="text-center mb-8 max-w-[832px] mx-auto">Login your account to order a coffee.</p>
					<button
					...
					<form className="flex flex-col gap-5" onSubmit={handleLogin}>
						...
						<p>
							Forget password? <Link to={"/forget-password"}>click here to change password</Link>
						</p>
						<button
							type="submit"
